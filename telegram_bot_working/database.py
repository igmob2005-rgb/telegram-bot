        ...
        try:
            ...
            async with aiosqlite.connect(DB_PATH) as db:
                ...
                CREATE TABLE IF NOT EXISTS order_details (
                    ...
                    -- Комплекты
                    complex_polk_green INTEGER DEFAULT 0,
                    complex_polk_multicolor INTEGER DEFAULT 0,
                    complex_divizia_green INTEGER DEFAULT 0,
                    complex_divizia_multicolor INTEGER DEFAULT 0,
                    complex_kunashir_green INTEGER DEFAULT 0,
                    complex_kunashir_multicolor INTEGER DEFAULT 0,
                    complex_bastion_green INTEGER DEFAULT 0,
                    complex_bastion_black INTEGER DEFAULT 0,
                    complex_air_force_green INTEGER DEFAULT 0,
                    complex_air_force_blue INTEGER DEFAULT 0,
                    -- Элементы комплекта
                    fio_green INTEGER DEFAULT 0,
                    fio_multicolor INTEGER DEFAULT 0,
                    fio_black INTEGER DEFAULT 0,
                    fio_blue INTEGER DEFAULT 0,
                    fio_unique_multicolor INTEGER DEFAULT 0,
                    vsr_green INTEGER DEFAULT 0,
                    vsr_multicolor INTEGER DEFAULT 0,
                    vsr_black INTEGER DEFAULT 0,
                    vsr_blue INTEGER DEFAULT 0,
                    left_arm_green INTEGER DEFAULT 0, 
                    left_arm_multicolor INTEGER DEFAULT 0,
                    left_arm_black INTEGER DEFAULT 0,
                    left_arm_blue INTEGER DEFAULT 0,
                    right_arm_green INTEGER DEFAULT 0,
                    right_arm_multicolor INTEGER DEFAULT 0,
                    right_arm_black INTEGER DEFAULT 0,
                    right_arm_blue INTEGER DEFAULT 0,
                    -- Петлицы
                    pet_artill_green INTEGER DEFAULT 0,
                    pet_artill_multicolor INTEGER DEFAULT 0,
                    pet_land_defence_green INTEGER DEFAULT 0,
                    pet_land_defence_multicolor INTEGER DEFAULT 0,
                    pet_svyaz_green INTEGER DEFAULT 0,
                    pet_svyaz_multicolor INTEGER DEFAULT 0,
                    pet_tank_green INTEGER DEFAULT 0,
                    pet_tank_multicolor INTEGER DEFAULT 0,
                    pet_inzh_green INTEGER DEFAULT 0,
                    pet_inzh_multicolor INTEGER DEFAULT 0,
                    pet_RHBZ_green INTEGER DEFAULT 0,
                    pet_RHBZ_multicolor INTEGER DEFAULT 0,
                    pet_orkestr_green INTEGER DEFAULT 0,
                    pet_orkestr_multicolor INTEGER DEFAULT 0,
                    pet_juridich_green INTEGER DEFAULT 0,
                    pet_juridich_multicolor INTEGER DEFAULT 0,
                    pet_automobil_green INTEGER DEFAULT 0,
                    pet_automobil_multicolor INTEGER DEFAULT 0,
                    pet_air_defence_green INTEGER DEFAULT 0,
                    pet_air_defence_multicolor INTEGER DEFAULT 0,
                    -- Дневальные
                    dnev_park INTEGER DEFAULT 0,
                    dnev_rota INTEGER DEFAULT 0,
                    dnev_shtab INTEGER DEFAULT 0,
                    -- Помощник дежурного
                    pom_deg_chast INTEGER DEFAULT 0,
                    pom_deg_bat INTEGER DEFAULT 0,
                    pom_deg_rot INTEGER DEFAULT 0,
                    pom_deg_stol INTEGER DEFAULT 0,
                    pom_deg_park INTEGER DEFAULT 0,
                    pom_deg_kpp INTEGER DEFAULT 0,
                    pom_deg_kpp_2 INTEGER DEFAULT 0,
                    pom_deg_divizia INTEGER DEFAULT 0,
                    pom_deg_poligon INTEGER DEFAULT 0,
                    -- Дежурный
                    deg_chast INTEGER DEFAULT 0,
                    deg_bat INTEGER DEFAULT 0,
                    deg_rot INTEGER DEFAULT 0,
                    deg_stol INTEGER DEFAULT 0,
                    deg_park INTEGER DEFAULT 0,
                    deg_kpp INTEGER DEFAULT 0,
                    deg_kpp_2 INTEGER DEFAULT 0,
                    deg_divizia INTEGER DEFAULT 0,
                    deg_poligon INTEGER DEFAULT 0,
                    -- Оперативный дежурный
                    oper_deg_chast INTEGER DEFAULT 0,
                    oper_deg_bat INTEGER DEFAULT 0,
                    oper_deg_rot INTEGER DEFAULT 0,
                    oper_deg_stol INTEGER DEFAULT 0,
                    oper_deg_park INTEGER DEFAULT 0,
                    oper_deg_kpp INTEGER DEFAULT 0,
                    oper_deg_kpp_2 INTEGER DEFAULT 0,
                    oper_deg_divizia INTEGER DEFAULT 0,
                    oper_deg_poligon INTEGER DEFAULT 0,
                    -- Другое
                    kepka INTEGER DEFAULT 0,
                    birka INTEGER DEFAULT 0,
                    value TEXT,
